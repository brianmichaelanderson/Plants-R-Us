...
export const CartModal = () => {
  ...
  return (
    <motion.div
      ...
      // Above causes this entire div to slide in from the right
      className='flex flex-col w-full max-w-xl h-screen bg-white'
    >
        ...
        <>
          <div className='flex-1 overflow-y-scroll'>
            {cartItems.map((item) => (
              <div
                key={item.id}
                className='mx-6 my-10 border-b-2 border-slate-200'
              >
